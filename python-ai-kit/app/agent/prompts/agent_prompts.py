...
TEXT_AGENT_RULES = """
## Additional Rules
- The answer should be detailed but concise and cover each aspect of the user question
  and consider relevant user context.
...
- You MUST use a tool to answer factual questions. However, if the user's message is a simple greeting,
  farewell, expression of gratitude, casual small talk, or conversational remark,
